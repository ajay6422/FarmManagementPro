...
public final class ItemUserMessageBinding implements ViewBinding {
  ...
  private ItemUserMessageBinding(@NonNull LinearLayout rootView, @NonNull TextView tvMessage) {
  ...
  public static ItemUserMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemUserMessageBinding((LinearLayout) rootView, tvMessage);
    }
