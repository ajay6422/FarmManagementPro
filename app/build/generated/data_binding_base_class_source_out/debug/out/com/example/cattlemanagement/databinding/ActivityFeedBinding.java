...
public final class ActivityFeedBinding implements ViewBinding {
  ...
  private ActivityFeedBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView feedRecycler) {
  ...
  public static ActivityFeedBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.feedRecycler;
      RecyclerView feedRecycler = ViewBindings.findChildViewById(rootView, id);
      if (feedRecycler == null) {
        break missingId;
      }

      return new ActivityFeedBinding((LinearLayout) rootView, feedRecycler);
    }
