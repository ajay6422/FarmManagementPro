...
public final class ActivityDetectBinding implements ViewBinding {
  ...
  private ActivityDetectBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnCapture,
      @NonNull ConstraintLayout main, @NonNull PreviewView previewView, @NonNull TextView txtLink,
  ...
  public static ActivityDetectBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDetectBinding((ConstraintLayout) rootView, btnCapture, main, previewView,
          txtLink, txtResult);
    }
