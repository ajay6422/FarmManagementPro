...
class RecordMilkActivity : AppCompatActivity() {
            ...
            card.setOnLongClickListener {
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Yes") { _, _ ->
                        db.child("milk_records").child(key).removeValue()
    ...
    // ➕ ADD MILK DIALOG (YOUR ORIGINAL FULL CODE)
    private fun openAddDialog() {

        val view = LayoutInflater.from(this)
            .inflate(R.layout.dialog_add_milk, null)
        ...
        val adapter = ArrayAdapter(this, android.R.layout.simple_spinner_item, cowList)
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        ...
        btnSave.setOnClickListener {
            ...
            val evening = etEvening.text.toString().toDoubleOrNull() ?: 0.0
            ...
            db.child("milk_records").push().setValue(map)
